...
set_target_properties(LibDataChannel::LibDataChannel PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libdatachannel.so"
  IMPORTED_SONAME_RELEASE "libdatachannel.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS LibDataChannel::LibDataChannel )
list(APPEND _IMPORT_CHECK_FILES_FOR_LibDataChannel::LibDataChannel "${_IMPORT_PREFIX}/lib/libdatachannel.so" )
